...
Estou usando: **AI Job Market Trends 2022-2026** (Kaggle) Por quê? Porque é relevante, tem dados numéricos e categóricos, e é sobre a área que estou estudando.
...
Leia: `recursos_adicionais/dicas_matematica.md`

**Spoiler:** Você não precisa de QI 190. Precisa de paciência. 
...
**Este é um repositório para aprender junto.**